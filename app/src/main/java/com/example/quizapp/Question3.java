    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(rb3.getId() == selectedid) {
                    marks++;
                    rb3.setBackgroundColor(Color.parseColor("#85e085"));
                    rb1.setBackgroundColor(Color.parseColor("#ff8080"));
                    rb2.setBackgroundColor(Color.parseColor("#ff8080"));
                    rb4.setBackgroundColor(Color.parseColor("#ff8080"));
                    Toast toast =
                            Toast.makeText(Question3.this,"Correct answer",Toast.LENGTH_SHORT);
                    toast.show();
                }
                else{
                    rb3.setBackgroundColor(Color.parseColor("#85e085"));
                    ...
                    rb4.setBackgroundColor(Color.parseColor("#ff8080"));
                    Toast toast =
                            Toast.makeText(Question3.this,"Wrong answer",Toast.LENGTH_SHORT);
                    toast.show();
        ...
        bt3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)  {
                ...
                intent3.putExtra("marks","Correct Answers ="+marks);
