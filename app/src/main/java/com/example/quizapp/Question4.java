    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (rb2.getId() == selectedid) {
                    ...
                    Toast toast =
                            Toast.makeText(Question4.this,"Correct answer",Toast.LENGTH_SHORT);
                    toast.show();
                } else {
                    rb2.setBackgroundColor(Color.parseColor("#85e085"));
                    rb1.setBackgroundColor(Color.parseColor("#ff8080"));
                    ...
                    rb4.setBackgroundColor(Color.parseColor("#ff8080"));
                    Toast toast =
                            Toast.makeText(Question4.this,"Wrong answer",Toast.LENGTH_SHORT);
                    toast.show();
        ...
        bt3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent4 = new Intent(Question4.this, Result.class);
                intent4.putExtra("marks", "Correct Answers =" + marks);
